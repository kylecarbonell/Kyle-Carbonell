...
function App() {
  ...
  const projectsRef = useRef(null) as unknown as MutableRefObject<HTMLDivElement>
  const contactRef = useRef(null) as unknown as MutableRefObject<HTMLDivElement>
    ...
    <>
      <div className="App-Structure">
        <div className='Bar-Structure'>
          <Bar about={() => { goTo(aboutRef) }}
            projects={() => { goTo(projectsRef) }}
            contact={() => { goTo(contactRef) }}></Bar>
        </div>


        <div className='Content-Structure'>
          <div className='Home-Structure' ref={homeRef}><Home /></div>
          <div className='About-Structure' ref={aboutRef}><About /></div>
          <div className='Projects-Structure' ref={projectsRef}><Projects></Projects></div>
